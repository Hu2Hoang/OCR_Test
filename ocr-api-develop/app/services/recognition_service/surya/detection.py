...
from app.services.recognition_service.surya.model.detection.segformer import SegformerForRegressionMask
from app.services.recognition_service.surya.postprocessing.heatmap import get_and_clean_boxes
from app.services.recognition_service.surya.postprocessing.affinity import get_vertical_lines
from app.services.recognition_service.surya.input.processing import prepare_image_detection, split_image, get_total_splits, convert_if_not_rgb
from app.services.recognition_service.surya.schema import TextDetectionResult
from app.services.recognition_service.surya.settings import settings
